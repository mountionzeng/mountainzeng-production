...
export const DICE_FACES: DiceFace[] = [
  ...
  // ── 03 算法 ──────────────────────────────────────────────────────────────
  {
    ...
    homeDescription:
      "我发现数学思维让我的行为更简洁高效。它教会我抽象问题、寻找模式、在复杂度与效率之间找到平衡。这种严谨性一方面支撑我读懂论文，理解算法与 AI 的方法本质；另一方面又在产品实践中被不断验证和修正。对我来说，产品能力与论文能力不是两条线，而是相互支撑、相互强化的同一套能力系统。",
    skills: [],
