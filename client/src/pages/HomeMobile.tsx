...
const MOBILE_HOME_TITLE_SCALE_MULTIPLIER = 1.14;
const MOBILE_HOME_TITLE_OFFSET_Y_ADJUST = -31;
const MOBILE_HOME_CONTENT_OFFSET_Y_ADJUST = -41;
...
export default function HomeMobile() {
  ...
  const titleOffsetY =
    MOBILE_HOME_TITLE_TUNING.offsetY + MOBILE_HOME_LINKED_OFFSET_Y + MOBILE_HOME_TITLE_OFFSET_Y_ADJUST;
  const titleScale = MOBILE_HOME_TITLE_TUNING.scale * MOBILE_HOME_TITLE_SCALE_MULTIPLIER;
  const diceOffsetY = MOBILE_HOME_DICE_TUNING.offsetY + MOBILE_HOME_LINKED_OFFSET_Y;
  const contentShiftY = MOBILE_HOME_CONTENT_SHIFT_Y + MOBILE_HOME_CONTENT_OFFSET_Y_ADJUST;
